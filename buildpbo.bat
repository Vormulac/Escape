...
"C:\Program Files (x86)\Bohemia Interactive\Tools\BinPBO Personal Edition\BinPBO.exe" "%WORKSPACE%\checkout\escape.altis" "%WORKSPACE%" -PROJECT "%WORKSPACE%\checkout\escape.altis" -PREFIX
echo Created PBOs
